...
class Rol implements RoleInterface
{
     ...
     * Add users
     *
     * @param \AdminBundle\Entity\Usuario $users
     * @return Rol
     */
    public function addUser(\AdminBundle\Entity\Usuario $users)
    {
        $this->users[] = $users;
     ...
     * @param \AdminBundle\Entity\Usuario $users
     */
    public function removeUser(\AdminBundle\Entity\Usuario $users)
    {
