 ...
 */
class Usuario extends \AdminBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'password', 'active', 'salt', 'name', 'avatar', 'groups'];
        }
