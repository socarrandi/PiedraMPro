 ...
 */
class Cargo extends \PiedraBundle\Entity\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PiedraBundle\\Entity\\Cargo' . "\0" . 'id', '' . "\0" . 'PiedraBundle\\Entity\\Cargo' . "\0" . 'cargo'];
        }
