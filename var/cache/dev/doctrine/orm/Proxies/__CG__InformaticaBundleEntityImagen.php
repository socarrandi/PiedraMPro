 ...
 */
class Imagen extends \InformaticaBundle\Entity\Imagen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\Imagen' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\Imagen' . "\0" . 'imagen', '' . "\0" . 'InformaticaBundle\\Entity\\Imagen' . "\0" . 'descripcion'];
        }
