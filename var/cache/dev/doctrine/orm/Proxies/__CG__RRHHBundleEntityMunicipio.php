 ...
 */
class Municipio extends \RRHHBundle\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RRHHBundle\\Entity\\Municipio' . "\0" . 'id', '' . "\0" . 'RRHHBundle\\Entity\\Municipio' . "\0" . 'municipio', '' . "\0" . 'RRHHBundle\\Entity\\Municipio' . "\0" . 'provincia'];
        }
