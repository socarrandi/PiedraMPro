 ...
 */
class TipoMovimiento extends \InformaticaBundle\Entity\TipoMovimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\TipoMovimiento' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\TipoMovimiento' . "\0" . 'tipo'];
        }
