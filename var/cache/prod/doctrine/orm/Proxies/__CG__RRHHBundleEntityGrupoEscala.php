 ...
 */
class GrupoEscala extends \RRHHBundle\Entity\GrupoEscala implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RRHHBundle\\Entity\\GrupoEscala' . "\0" . 'id', '' . "\0" . 'RRHHBundle\\Entity\\GrupoEscala' . "\0" . 'grupo', '' . "\0" . 'RRHHBundle\\Entity\\GrupoEscala' . "\0" . 'salarioEscala'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GrupoEscala $proxy) {
