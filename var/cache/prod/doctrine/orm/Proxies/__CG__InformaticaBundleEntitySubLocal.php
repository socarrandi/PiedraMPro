 ...
 */
class SubLocal extends \InformaticaBundle\Entity\SubLocal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\SubLocal' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\SubLocal' . "\0" . 'subLocal', '' . "\0" . 'InformaticaBundle\\Entity\\SubLocal' . "\0" . 'local', '' . "\0" . 'InformaticaBundle\\Entity\\SubLocal' . "\0" . 'unidad', '' . "\0" . 'InformaticaBundle\\Entity\\SubLocal' . "\0" . 'codigo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubLocal $proxy) {
    ...
    public function setSubLocal($subLocal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubLocal', [$subLocal]);

        return parent::setSubLocal($subLocal);
    }
    ...
    public function getSubLocal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubLocal', []);

        return parent::getSubLocal();
    }
