 ...
 */
class Cargo extends \InformaticaBundle\Entity\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\Cargo' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\Cargo' . "\0" . 'cargo'];
        }
