 ...
 */
class Provincia extends \RRHHBundle\Entity\Provincia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RRHHBundle\\Entity\\Provincia' . "\0" . 'id', '' . "\0" . 'RRHHBundle\\Entity\\Provincia' . "\0" . 'provincia'];
        }
