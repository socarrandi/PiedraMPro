 ...
 */
class Conexion extends \InformaticaBundle\Entity\Conexion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'tipo', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'driver', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'user', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'password', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'host', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'port', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'dbname', '' . "\0" . 'InformaticaBundle\\Entity\\Conexion' . "\0" . 'unidad'];
        }
