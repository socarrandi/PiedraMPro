 ...
 */
class Unidad extends \RRHHBundle\Entity\Unidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'id', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'unidad', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'cita', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'municipio', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'provincia', '' . "\0" . 'RRHHBundle\\Entity\\Unidad' . "\0" . 'telefono'];
        }
