 ...
 */
class Telefono extends \InformaticaBundle\Entity\Telefono implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\Telefono' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\Telefono' . "\0" . 'responsable', '' . "\0" . 'InformaticaBundle\\Entity\\Telefono' . "\0" . 'telefono', '' . "\0" . 'InformaticaBundle\\Entity\\Telefono' . "\0" . 'descripcion'];
        }
