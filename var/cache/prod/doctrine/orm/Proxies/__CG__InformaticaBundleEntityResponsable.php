 ...
 */
class Responsable extends \InformaticaBundle\Entity\Responsable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'InformaticaBundle\\Entity\\Responsable' . "\0" . 'id', '' . "\0" . 'InformaticaBundle\\Entity\\Responsable' . "\0" . 'responsable', '' . "\0" . 'InformaticaBundle\\Entity\\Responsable' . "\0" . 'local', '' . "\0" . 'InformaticaBundle\\Entity\\Responsable' . "\0" . 'cargo', '' . "\0" . 'InformaticaBundle\\Entity\\Responsable' . "\0" . 'unidad'];
        }
