 ...
 */
class UsuarioRed extends \PiedraBundle\Entity\UsuarioRed implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PiedraBundle\\Entity\\UsuarioRed' . "\0" . 'id', '' . "\0" . 'PiedraBundle\\Entity\\UsuarioRed' . "\0" . 'usuario', '' . "\0" . 'PiedraBundle\\Entity\\UsuarioRed' . "\0" . 'dominio', '' . "\0" . 'PiedraBundle\\Entity\\UsuarioRed' . "\0" . 'departamento'];
        }
